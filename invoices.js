...
function updatePreview() {
    ...
    invoiceState.services.forEach(svc => {
        ...
        servicesHtml += `<tr>
            ...
            <td class="align-right">€${priceInfo.taxAmount.toFixed(2)}</td>
        ...
        <div class="invoice-document">
            <div class="invoice-header">
                <div class="invoice-title">
                    <h1>Glow Bliss Beauty Parlour</h1>
            ...
            <table class="invoice-items">
                <thead>
                    <tr>
                        ...
                        <th class="align-right">Tax Amount</th>
            ...
            ${paymentMethod ? `<p class="payment-info"><strong>Payment Method:</strong> ${paymentMethod}</p>` : ''}
            ${notes ? `<p class="notes-info"><strong>Notes:</strong> ${notes}</p>` : ''}
            
            <p class="invoice-footer">Thank you for your business! | www.glowbliss-beautyparlour.nl</p>
        </div>
    `;
